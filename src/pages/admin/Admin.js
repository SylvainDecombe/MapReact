...
function Admin() {
    ...
    const updateCustomer = () => CustomersService.update(modalCustomerEditData);
    ...
    return ( <
        ...
        div id = "CustomerAdd" >
        <
        Modal isOpen = { modalCustomerAdd }
        toggle = { toggleModalCustomerAdd } >
        <
        ...
        onClick = { saveCustomer } > Créer < /Button> <
        Button color = "danger"
        onClick = { toggleModalCustomerAdd } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        div id = "CustomerView" >
        <
        Modal isOpen = { modalCustomerView }
        toggle = { toggleModalCustomerView } >
        <
        ...
        <
        Button color = "danger"
        onClick = { toggleModalCustomerView } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        div id = "CustomerEdit" >
        <
        Modal isOpen = { modalCustomerEdit }
        toggle = { toggleModalCustomerEdit } >
        <
        ...
        <
        Button color = "success"
        onClick = { updateCustomer } > Mettre à jour < /Button> <
        Button color = "danger"
        onClick = { toggleModalCustomerEdit } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        <
        Modal isOpen = { modalCustomerDelete }
        toggle = { toggleModalCustomerDelete } >
        <
        ...
        <
        Button color = "success"
        onClick = { deleteCustomer } > Bien sur! < /Button> <
        Button color = "danger"
        onClick = { toggleModalCustomerDelete } > Oups pardon < /Button> < /
        ModalFooter > <
        /Modal> < /
        div > <
        /div>
        ...
        <
        Modal isOpen = { modalManufacturerAdd }
        toggle = { toggleModalManufacturerAdd } >
        <
        ...
        <
        Button color = "success"
        onClick = { saveManufacturer } > Créer < /Button> <
        Button color = "danger"
        onClick = { toggleModalManufacturerAdd } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        <
        Modal isOpen = { modalManufacturerView }
        toggle = { toggleModalManufacturerView } >
        <
        ...
        <
        Button color = "danger"
        onClick = { toggleModalManufacturerView } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        <
        Modal isOpen = { modalManufacturerEdit }
        toggle = { toggleModalManufacturerEdit } >
        <
        ...
        <
        Button color = "success"
        onClick = { updateManufacturer } > Mettre à jour < /Button> <
        Button color = "danger"
        onClick = { toggleModalManufacturerEdit } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        div id = "CustomerDelete" >
        <
        Modal isOpen = { modalManufacturerDelete }
        toggle = { toggleModalManufacturerDelete } >
        <
        ...
        <
        Button color = "success"
        onClick = { deleteManufacturer } > Bien sur! < /Button> <
        Button color = "danger"
        onClick = { toggleModalManufacturerDelete } > Oups pardon < /Button> < /
        ModalFooter > <
        /Modal> < /
        div > <
        /div>
        ...
        div id = "UserAdd" >
        <
        Modal isOpen = { modalUserAdd }
        toggle = { toggleModalUserAdd } >
        <
        ...
        <
        Button color = "success"
        onClick = { saveUser } > Créer < /Button> <
        Button color = "danger"
        onClick = { toggleModalUserAdd } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        div id = "UserView" >
        <
        Modal isOpen = { modalUserView }
        toggle = { toggleModalUserView } >
        <
        ...
        <
        Button color = "danger"
        onClick = { toggleModalUserView } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        div id = "UserEdit" >
        <
        Modal isOpen = { modalUserEdit }
        toggle = { toggleModalUserEdit } >
        <
        ...
        <
        Button color = "success"
        onClick = { updateUser } > Mettre à jour < /Button> <
        Button color = "danger"
        onClick = { toggleModalUserEdit } > Fermer < /Button> < /
        ModalFooter > <
        /Modal> < /
        div >
        ...
        <
        Button color = "success"
        onClick = { deleteUser } > Bien sur! < /Button> <
        Button color = "danger"
        onClick = { toggleModalUserDelete } > Oups pardon < /Button> < /
        ModalFooter > <
        /Modal> < /
        div > <
        /div>
